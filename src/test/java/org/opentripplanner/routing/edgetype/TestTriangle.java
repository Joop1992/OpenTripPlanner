...
public class TestTriangle extends TestCase {
    ...
    public void testTriangle() {
        ...
        BikeTriangle bikeTriangle = options.bikeTriangle;
        bikeTriangle.setTriangleSafetyFactor(0);
        bikeTriangle.setTriangleSlopeFactor(0);
        bikeTriangle.setTriangleTimeFactor(1);
        ...
        bikeTriangle.setTriangleSafetyFactor(0);
        bikeTriangle.setTriangleSlopeFactor(1);
        bikeTriangle.setTriangleTimeFactor(0);
        ...
        bikeTriangle.setTriangleSafetyFactor(1);
        bikeTriangle.setTriangleSlopeFactor(0);
        bikeTriangle.setTriangleTimeFactor(0);
        startState = new State(v1, options);
        result = testStreet.traverse(startState);
        ...
        bikeTriangle.setTriangleSafetyFactor(ONE_THIRD);
        bikeTriangle.setTriangleSlopeFactor(ONE_THIRD);
        bikeTriangle.setTriangleTimeFactor(ONE_THIRD);
        startState = new State(v1, options);
        result = testStreet.traverse(startState);
